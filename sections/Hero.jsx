...
const Hero = () => (
  <section className={`${styles.yPaddings} sm:pl-16 pl-6`}>
    ...
    <div className="flex justify-center items-center flex-col lative z-10">
    ...
    <motion.div variants={slideIn("right", "tween", 0.2, 1)} className="relative w-full md:-mt-[20px] -mt-[12px]">
      <div className="absolute w-full h-[300px] hero-gradient rounded-tl-[140px] z-[0] -top-[30px]" />
        <img src='/cover.png' alt="hero banner" className="w-full sm:h-[500px] h-[350px] object-cover rounded-tl-[140px] z-[10px] relative"/>
        <a href="#explore">
